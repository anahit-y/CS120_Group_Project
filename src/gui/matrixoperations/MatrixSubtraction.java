...
public class MatrixSubtraction extends JButton implements OperationButton{
    private JPanel rightPanel; // Panel to update

    public MatrixSubtraction(String name, JPanel panel) {
        super(name);
    ...
    public void openPanel() {
        ...
        setButton.addActionListener(k -> {
            try {
                ...
                setButton.openTwoWindows(dimension1, dimension2, "Matrix", "Subtraction");
