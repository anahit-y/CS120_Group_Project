...
public class RowEchelon extends JButton implements OperationButton {
    private JPanel rightPanel; // Panel to update

    public RowEchelon(String name, JPanel panel) {
        super(name);
    ...
    public void openPanel() {
        ...
        setButton.addActionListener(k -> {
            try {
                ...
                setButton.openOneWindow(dimension1, dimension2, "Matrix", "Row Echelon");
