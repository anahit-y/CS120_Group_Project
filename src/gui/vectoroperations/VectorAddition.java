...
public class VectorAddition extends JButton implements OperationButton {
    private JPanel rightPanel; // Panel to update

    public VectorAddition(String name, JPanel panel) {
        super(name);
    ...
    public void openPanel() {
        ...
        setButton.addActionListener(k -> {
            try {
                ...
                setButton.openTwoWindows(1, dimension1, "Vector", "Addition");
