...
public class Distance extends JButton implements OperationButton {
    private JPanel rightPanel; // Panel to update

    public Distance(String name, JPanel panel) {
        super(name);
    ...
    public void openPanel() {
        ...
        setButton.addActionListener(k -> {
            try {
                ...
                setButton.openTwoWindows(1, dimension1, "Vector", "Distance");
