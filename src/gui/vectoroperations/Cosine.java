...
public class Cosine extends JButton implements OperationButton {
    private JPanel rightPanel; // Panel to update

    public Cosine(String name, JPanel panel) {
        super(name);
    ...
    public void openPanel() {
        ...
        setButton.addActionListener(k -> {
            try {
                ...
                setButton.openTwoWindows(1, dimension1, "Vector", "Cosine");
